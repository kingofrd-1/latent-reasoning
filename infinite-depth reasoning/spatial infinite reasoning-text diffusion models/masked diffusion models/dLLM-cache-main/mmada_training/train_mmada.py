...
def main():
    ...
    def prepare_inputs_and_labels_for_mmu(
        ...
        masked_indices = noisy_batch == mask_id 
        noisy_batch[prompt_masks.bool()] = input_ids_mmu[prompt_masks.bool()] # keep the prompt tokens without mask
        masked_indices = noisy_batch == mask_id 
