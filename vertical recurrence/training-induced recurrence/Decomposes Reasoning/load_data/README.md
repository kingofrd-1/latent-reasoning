...
If you want to generate the memory step and the reason step naturally without order， we suggest running modify_version to ensure the quality of the generated data:
```
